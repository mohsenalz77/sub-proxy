    ...
    if (isBrowser) {
      ...
      <head>
          ...
          <style>
              ...
              .status-badge { display: inline-flex; align-items: center; gap: 12px; background: rgba(18, 22, 43, 0.7); padding: 10px 24px; border-radius: 50px; border: 1px solid ${statusColor}; font-size: 0.9rem; margin-bottom: 30px; }
